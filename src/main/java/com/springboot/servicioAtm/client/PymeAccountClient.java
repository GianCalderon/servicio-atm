...
@Service
public class PymeAccountClient {
	
	
private static final Logger LOGGER = LoggerFactory.getLogger(PymeAccountClient.class);
	
//	@Autowired
//	private WebClient client;

WebClient client = WebClient.create("http://localhost:8013/api/pymeAccount");
