...
@Service
public class CorporativeAccountClient {
	
	
private static final Logger LOGGER = LoggerFactory.getLogger(CorporativeAccountClient.class);
	
//	@Autowired
//	private WebClient client;

WebClient client = WebClient.create("http://localhost:8014/api/corporativeAccount");
